                        ...
                        <table id="entrydata" class="table table-striped table-bordered new-tbl">
                          ...
                          <tbody>
                            <tr class="leftMenu">
								...
								<td>Odo(Km)</td>-->
								<td>Moving</td>
								<td>Alcon Chambers Panjim Goa 403001 India</td>
								<td>2016-11-27 23:20:17</td>
								<!--<td>23:20:17</td>-->
                            </tr>
                          </tbody>
                        </table>
...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCeQdAwrHm8Zap7jwX_gNRA3dhH-CxdCWQ&callback=initMap"></script>
