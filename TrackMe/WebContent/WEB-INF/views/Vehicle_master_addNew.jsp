				...
				<div class="col-sm-12 ">
					<div class="row">
						...
						<div class="form-group col-sm-4">
							...
							<form:input path="unitNo" type="text" id="unitNo" class="form-control"></form:input>
						</div>
						<div class="form-group col-sm-4">
						...
						<div class="form-group col-sm-4">
							...
							<form:input path="currentOdiMeter" type="text" id="odo" size="15" class="form-control"></form:input>
						</div>
						<div class="form-group col-sm-4">
							<label>Current Fuel:</label>
							<form:input path="currentFuel" type="text" id="fuel" class="form-control"></form:input>
						</div>
						<div class="form-group col-sm-4">
							<label>Service(Km):</label>
							<form:input path="serviceKm" type="text" id="service" class="form-control"></form:input>
						</div>
						<div class="form-group col-sm-4">
						...
						<div class="form-group col-sm-4">
							...
							<form:input path="ownerContact1" type="text"  id="owner1" class="form-control"></form:input>
						</div>
						<div class="form-group col-sm-4">
							<label>Contact 2:</label>
							<form:input path="ownerContact2" type="text" id="owner2"  class="form-control"></form:input>
						</div>
						<div class="form-group col-sm-4">
							<label>Email:</label>
							<form:input path="ownerEmail" type="text" id="email"  class="form-control"></form:input>
						</div>
						<div class="form-group col-sm-4">
							<label>Address:</label>
						...
						<div class="form-group col-sm-4">
							<label>Pin:</label>
							<form:input path="ownerPinCode" type="text" id="pin" class="form-control"></form:input>
						</div>
